...
const str = "Укажите возможный генокод монстра в яйце после разведения Гранатон с генокодом h27a31d38s7sa25sd29 с Гранатоном с генок";
// const str2 = JSON.stringify(str).slice(1,-1);
const str1 = JSON.stringify(str).slice(1,-1).replace(/[^а-яА-Я\d]/g, '').toLowerCase();
console.log(str);
// console.log(str2)
console.log(str1);
